        ...
        <form action="{{ route('users.store') }}" method="POST" class="px-8 py-6 space-y-6">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="first_name" required value="{{ old('first_name') }}" class="mt-2 block w-full rounded-md border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-blue-600 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="middle_name" value="{{ old('middle_name') }}" class="mt-2 block w-full rounded-md border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-blue-600 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="last_name" required value="{{ old('last_name') }}" class="mt-2 block w-full rounded-md border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-blue-600 sm:text-sm">
