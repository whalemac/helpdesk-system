                        ...
                        <li class="flex items-center justify-between gap-x-6 px-6 py-5 hover:bg-gray-50 transition">
                            <div class="min-w-0">
                                ...
                                @if($category->description)
                                    <p class="mt-1 flex text-xs leading-5 text-gray-500">{{ $category->description }}</p>
                                @endif
                            </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            <form action="{{ route('categories.store') }}" method="POST" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" required class="mt-2 block w-full rounded-md border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6">
                </div>
                <div>
                    <label class="block text-sm font-medium leading-6 text-gray-900">Description</label>
                    <textarea name="description" rows="3" class="mt-2 block w-full rounded-md border-0 py-2 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"></textarea>
                </div>
                <div>
                ...
                <div class="pt-2">
                    <button type="submit" class="w-full rounded-md bg-blue-600 px-3 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition">
                        Create Category
                    </button>
                </div>
            </form>
