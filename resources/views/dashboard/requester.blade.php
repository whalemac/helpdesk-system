...
<div class="mb-8 flex items-center justify-between">
    ...
    <a href="{{ route('tickets.create') }}" class="rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 transition flex items-center gap-2">
                ...
                @empty
                    <tr>
                        <td colspan="7" class="py-16 text-center">
                            ...
                            <a href="{{ route('tickets.create') }}" class="mt-4 inline-flex rounded-lg bg-blue-600 px-5 py-2 text-sm font-bold text-white hover:bg-blue-500 transition">Submit Your First Ticket</a>
                        </td>
                    </tr>
                @endforelse
            </tbody>
