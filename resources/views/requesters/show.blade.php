        ...
        <div class="rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden mb-8">
            <div class="p-8">
                <div class="flex items-center gap-x-6">
                    <div
                        class="h-20 w-20 flex-shrink-0 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 text-2xl font-bold">
                        {{ substr($requester->first_name, 0, 1) }}{{ substr($requester->last_name, 0, 1) }}
                    </div>
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">{{ $requester->first_name }}
                            {{ $requester->last_name }}</h2>
