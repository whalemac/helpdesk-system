        ...
        <aside class="hidden w-64 overflow-y-auto bg-slate-900 md:block flex-shrink-0">
            <div class="py-6 text-white">
                ...
                <ul class="mt-8 space-y-2">
                    ...
                    @if(auth()->user()->role === 'admin')
                        <li class="relative px-6 py-3">
                            <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 {{ request()->routeIs('system.*') ? 'text-white' : 'text-gray-400 hover:text-white' }}"
        ...
        <div class="flex flex-col flex-1 w-full relative h-screen">
            ...
            <main class="h-full overflow-y-auto bg-gray-50/50 p-8">
                <div class="mx-auto max-w-7xl">
                    ...
                    @if(session('error'))
                        <div
                            class="mb-6 rounded-lg bg-red-50 border border-red-200 p-4 text-red-700 flex items-center gap-3">
                            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
